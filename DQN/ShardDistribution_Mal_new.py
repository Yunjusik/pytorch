...
class ShardDistribute(gym.Env):
    def __init__(self):
        ...
        self.nb_nodes = 200
        self.nb_MalNode = 10 #round(200*random.randrange(1,21)*0.01)
        self.H_history = []
        self.e_prob = []
        self.NodesinShard = []
    ...
    def ShardDist(self, Shard_numb):  # shard dist를 통해 R,C,H를 한번에 관리하자
        ...
        if (Shard_numb >= 2):
            ...
            for i in range(nb_nodes):
                ...
                ShardCount[tmp] += 1
               ### 다 돌고나면 shardcount[i] 는 i번째샤드의 노드수임
        ...
        return self.H_history, self.e_prob, self.NodesInShard, self.Success_ratio
